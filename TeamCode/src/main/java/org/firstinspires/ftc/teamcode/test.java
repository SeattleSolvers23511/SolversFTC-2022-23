...
public class test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        motorFrontLeft = hardwareMap.dcMotor.get("motorFrontLeft"); // Defines Front Left Motor.
        motorBackLeft = hardwareMap.dcMotor.get("motorBackLeft"); // Defines Back Left Motor.
        motorFrontRight = hardwareMap.dcMotor.get("motorFrontRight"); // Defines Front Right Motor.
        motorBackRight = hardwareMap.dcMotor.get("motorBackRight"); // Defines Back Right Motor.
        motorLeftViperSlide = hardwareMap.get(DcMotorEx.class, "motorLeftViperSlide"); // Defines Left Viper Slide Motor.
        motorRightViperSlide = hardwareMap.get(DcMotorEx.class, "motorRightViperSlide"); // Defines Right Viper Slide Motor.

        Servo servoLeftClaw = hardwareMap.get(Servo.class, "servoLeftClaw"); // Defines Left Servo Claw motor.
        Servo servoRightClaw = hardwareMap.get(Servo.class, "servoRightClaw"); // Defines Right Servo Claw motor.
        ...
        while (opModeIsActive()) {
            ...
            // Note that when it is a non-zero number, it will be usually negative since moving the viper slide motor counterclockwise (which results in a negative position value) moves the viper slide up.
